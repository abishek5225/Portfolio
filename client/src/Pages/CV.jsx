...
const education = [
  { degree: "Bachelor of Computer Applications (BCA)", institution: "Mechi Multiple Campus", year: "2021 - Present" },
  { degree: "Senior High", institution: "Himalayan English Acedemy", year: "2019 - 2021" },
      ...
      <div>
        <div className="space-y-6">
          {education.map((edu, index) => (
            <div key={index} className="bg-white p-4 rounded-2xl shadow-lg hover:shadow-xl transition-all text-left">
    ...
    <div>
      ...
      <div className="max-w-3xl mx-auto bg-white p-8 rounded-2xl shadow-lg">
        <p className="text-gray-700 text-lg leading-relaxed text-justify">
          I have a deep passion for technology, always eager to explore and experiment with the latest
           advancements in software development, blockchain, and artificial intelligence. Beyond tech,
            I am fascinated by neuroscience, intrigued by how the human brain functions and the potential
             of mind-machine interfaces. I also have a strong inclination toward spirituality, appreciating 
             the philosophical perspectives that unify different beliefs and emphasize the idea of a universal 
             energy. Additionally, my curiosity extends to various scientific domains, where I enjoy learning 
             about the mysteries of the universe, quantum mechanics, and the fundamental principles that govern our reality.
        </p>
      </div>
    </section>
    </div>
